...
class RainbowVortex(tk.Canvas):
    ...
    def animate(self):
        ...
        for i in range(12):
            angle = math.radians(t * 4 + i * 30)
            color = self.get_color(hue_offset=i/12)
            r = 20 + i * 8
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("Rainbow Vortex")
    root.configure(bg='#0B0E14')
    
    # Glow Container
    spinner = RainbowVortex(root, width=400, height=400)

...
class InfinityLoop(tk.Canvas):
    ...
    def animate(self):
        ...
        self.create_line(pts[:40], fill=color1, width=10, smooth=True)
        self.create_line(pts[40:80], fill=color2, width=10, smooth=True)
        self.create_line(pts[80:], fill=color3, width=10, smooth=True)
